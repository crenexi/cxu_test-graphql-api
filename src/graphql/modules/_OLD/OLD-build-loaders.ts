...
import { ShipIdentity, shipIdentityLoader } from './modules/ship-identity';
import { ShipModel, shipModelLoader } from './modules/ship-model';
...
const buildLoaders = (): DataLoaders => ({
